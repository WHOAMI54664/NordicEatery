...
export function LoginForm() {
  ...
  const next = searchParams.get("next") || `/${locale}/kitchen`;
  ...
  return (
      <form onSubmit={handleLogin} className="glass-card mx-auto max-w-md p-6">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-5 text-3xl font-black text-dark">Staff Login</h1>
        ...
        <div className="space-y-4">
          <label>
            <span className="mb-2 block text-sm font-bold text-dark">Email</span>
            <input
                required
                type="email"
