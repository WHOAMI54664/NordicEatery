    ...
    return (
        <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
                        ...
                        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-dark shadow-sm transition hover:bg-cream"
                                >
                                    <Minus size={16} />
                                </button>
            ...
            <aside className="glass-card h-fit p-6">
                <h2 className="text-2xl font-black text-dark">{t("summaryTitle")}</h2>

                <div className="mt-6 space-y-3 text-sm">
                    <div className="flex justify-between">
                        <span className="text-dark/60">{t("subtotal")}</span>
                        <span className="font-black">{totalPrice} kr</span>
                    </div>

                    <div className="flex justify-between">
                        <span className="text-dark/60">{t("delivery")}</span>
                        <span className="font-black">{t("calculatedLater")}</span>
                    </div>
